...
# spring-boot-sample-cxf

**Spring Boot Starter for spring-boot-sample-cxf**

[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/spring-boot-sample-cxf)](https://github.com/easy-4-java/spring-boot-sample-cxf)
...
> **Artifact ID**：`spring-boot-sample-cxf`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**spring-boot-sample-cxf** is a Spring Boot starter that integrates **spring-boot-sample-cxf** for applications using spring-boot-sample-cxf. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume spring-boot-sample-cxf capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using spring-boot-sample-cxf |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for spring-boot-sample-cxf |
| JDK | `17` |
| Coordinates | `io.github.easy4j:spring-boot-sample-cxf:1.0.x.20260630-SNAPSHOT` |
| Config Prefix | `spring.boot.sample.cxf` |

## 2. Core Capabilities

| Capability | Status | Description |
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers spring-boot-sample-cxf beans automatically |
| Property Binding | ✅ Stable | Binds `spring.boot.sample.cxf.*` to `Properties` |
...
|---|---|---|:---:|---|:---:|
| `spring.boot.sample.cxf.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl spring-boot-sample-cxf -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `spring.boot.sample.cxf.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/spring-boot-sample-cxf/issues) · [Repository](https://github.com/easy-4-java/spring-boot-sample-cxf)
